...
4. If necessary, configure GodMode9:
   ...
   - Dacă vi se cere să reparați dara și ora RTC, apăsați (A) pentru a efectua, apoi setați data și ora, apoi apăsați (A) pentru a continua
5. Once you see [root] and a list of drives, press (Home) to bring up the action menu
6. Selectați "Scripts..." (_not_ Lua scripts)
7. Select "finalize"
...
10. Introduceți cardul SD în calculator

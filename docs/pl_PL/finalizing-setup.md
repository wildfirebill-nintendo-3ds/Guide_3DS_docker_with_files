...
2. Wybierz "Miscellaneous options"
...
4. If necessary, configure GodMode9:
   ...
   - Jeśli zostaniesz poproszony o ustawienie czasu RTC, naciśnij (A) aby to zrobić, następnie ustaw datę i czas, oraz naciśnij (A) aby kontynuować
5. Once you see [root] and a list of drives, press (Home) to bring up the action menu
6. Wybierz "Scripts..." (_not_ Lua scripts)
7. Select "finalize"

...
We're glad to hear that you'd like to contribute to 3ds.hacks.guide! 以下是您可以提出貢獻的幾種方法：
...
本手冊中大部分的檔案只提供 Torrent 種子。 If you'd like to help seed these torrents to ensure their availability in the future, you can download the `.zip` file containing all our `.torrent` files: [torrents.zip](/assets/torrents.zip) (last updated 2023-03-16)

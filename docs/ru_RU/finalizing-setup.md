...
4. If necessary, configure GodMode9:
   ...
   - Если вам предложат выставить RTC дату и время, нажмите кнопку (A) чтобы сделать это, настройте дату и время, затем нажмите (A) чтобы продолжить
5. Once you see [root] and a list of drives, press (Home) to bring up the action menu
6. Выберите "Scripts..." (_not_ Lua scripts)
7. Select "finalize"

...
## What You Need
* The latest release of [Soundhax](http://soundhax.com) *(for your region, console, and version)*Gonna leave site up for soundhax. Added sound_hax.md [sound_hax](_sound/Sound_hax.md) with all files 
    * If Soundhax appears in your browser as an unplayable video, press Ctrl+S or Cmd+S to save it to your computer
* The latest release of [_files/SafeB9SInstaller-20170605-122940.zip) (direct download)
...
* The latest release of [universal-otherapp](_files/otherapp.bin) (`otherapp.bin`)

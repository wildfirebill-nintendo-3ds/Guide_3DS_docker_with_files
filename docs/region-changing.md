...
Note that region changing is almost completely unnecessary since Luma3DS supports out-of-region games and individual title [Locale Emulation](_files/Locale_Emulation.md). Additionally, running NDS games with alternative out-of-region languages is supported by [TWiLight Menu++](_files/TWiLightMenu-3DS.7z). You should only perform a region change if you wish to have your system UI in a language that is not available on your console's current region.
...
* The latest release of [FBI](_files/FBI.3dsx) (direct download)
* The latest release of [faketik](_files/faketik.3dsx) *(the `.3dsx` file)*
* The latest release of [ctrtransfer.gm9](_files/ctrtransfer.gm9) (right click, save link as)

...
7. Paina (A)-painiketta vahvistaaksesi
   - This process will take some time
   - If you get an error, ensure you have at least 1.3GB of free space on your SD card
8. Paina (B):tä palataksesi päävalikkoon
9. Select “Exit”
10. Paina (HOME)-painiketta näyttääksesi toimintovalikon
...
5. Paina kehotettaessa (A):ta jatkaaksesi
6. Press (A) again to proceed
7. Paina (A):ta ottaaksesi käyttöön SysNANDiin kirjoittamisen (lvl3) ja syötä annettu painikeyhdistelmä
8. Paina (A):ta jatkaaksesi
9. Paina (A):ta lukitaksesi kirjoitusoikeudet kehotettaessa

...
4. If necessary, configure GodMode9:
   ...
   - Jos sinua kehotetaan korjaamaan RTC-aika ja -päivämäärä, paina (A):ta ja aseta ne oikein, paina sitten (A):ta jatkaaksesi
5. Once you see [root] and a list of drives, press (Home) to bring up the action menu
6. Select "Scripts..." (_not_ Lua scripts)
7. Select "finalize"
...
10. Aseta SD-korttisi tietokoneeseesi

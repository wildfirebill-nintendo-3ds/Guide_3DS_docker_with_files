...
5. Drücke (A), wenn du dazu aufgefordert wirst, um fortzufahren
6. Press (A) again to proceed
7. Drücke (A) um die Schreibrechte für SysNAND (lvl3) zu aktivieren und gibt dann die angezeigte Tastenkombination ein
8. Drücke (A), um fortzufahren
9. Drücke (A), um die Schreibrechte zu deaktivieren, wenn du dazu aufgefordert wirst
10. Drücke (Start), um deine Konsole neu zu starten
